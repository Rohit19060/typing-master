...
let words = ["article", "auxuliary", "abbey", "able", "about", "above", "absence", "absurd", "abuse", "accent", "acceptance", "accessoria", "accord", "account",
    ...
    "jamesi", "jane", "jasmine", "jazz", "jefferson", "jelly", "jerk", "jerker", "jerks", "jessamine", "jesus", "jewel", "jobless", "jobs", "john", "johns", "join", "joint", "joke", "joker", "jokes",
    ...
    "nail", "name", "namibia", "napkin", "narrow", "nasty", "national", "nations", "natural", "nature", "naval", "navy", "near", "nearby", "nearest", "nearly", "neat", "neck",
    ...
    "quotable", "quotation", "wordsArray", "quoted", "quoteunquote", "quotha", "quothe", "quotidian", "quotient", "reflexivepro", "relativepro", "rabbit", "rabble", "race", "rack", "racket",
    ...
    "separatism", "separatist", "sepulcher", "sepulchre", "serbia", "sergeon", "series", "serum", "service", "setter", "setting", "settled", "seven", "shade", "shaft", "shafted",
    ...
    "situated", "skater", "sketch", "sking", "skin", "slate", "slave", "slaver", "sleep", "sleeve", "slow", "small", "smallpox", "smelling", "smut", "snake", "snapdragon", "snapper", "socialist",
    ...
    "wrongheadedly", "wrongheadedness", "wrongly", "wrongness", "wrote", "wroth", "wrothful", "wrought", "wryly", "wryneck", "wtpf", "wuss", "wwwituint", "wych", "wycherley", "wycliffe",
    ...
    "xanthomatosis", "xanthopathy", "xanthophyl", "xanthophyll", "xanthopia", "xanthopsia", "xanthosis", "xanthous", "xanthuria", "xenagogy",
    ...
    "xerostomia", "xerotes", "xerotic", "xerotripsis", "xerox", "xerxes", "xhosa", "xiphias", "xiphioid", "xiphoid", "xmas",
